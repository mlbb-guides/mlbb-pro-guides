...
const HEROES_DATA = {
    ...
    // ===== FIGHTERS =====
    fighters: [
        { name: "Suyou", tier: "S+", winRate: 58.2, img: "https://akmweb.youngjoygame.com/web/madmin/image/572242038740c0612395d97f265b7501.png", color: "#ef233c" }, // New Hero
    ...
    // ===== MAGES =====
    mages: [
        { name: "Zhuxin", tier: "S+", winRate: 56.5, img: "https://akmweb.youngjoygame.com/web/madmin/image/b80144f86150247926b47cba0447385e.png", color: "#7209b7" }, // New Hero
...
const ITEMS = {
    ...
    "Winter Crown": { icon: "👑", type: "magic" }, // Replaces Winter Truncheon
    "Thunder Belt": { icon: "⚡", type: "defense" }, // Revamped
    ...
    // Magic
    "Starlium Scythe": { icon: "🌙", type: "magic" }, // Revamped Calamity Reaper
...
const BUILDS_DATA = {
    ...
    "Suyou": {
        ...
        img: "https://akmweb.youngjoygame.com/web/madmin/image/572242038740c0612395d97f265b7501.png"
    },
    "Zhuxin": {
        role: "Mage",
        difficulty: "Medium",
        ...
        img: "https://akmweb.youngjoygame.com/web/madmin/image/b80144f86150247926b47cba0447385e.png"
    },
    "Chip": {
        role: "Support/Tank",
        difficulty: "Hard",
    ...
    // ===== UPDATED BUILDS (SKY PIERCER / MALEFIC GUN ERA) =====
    "Hayabusa": {
        role: "Assassin",
        difficulty: "Hard",
        emblem: "Assassin - Killing Spree",
